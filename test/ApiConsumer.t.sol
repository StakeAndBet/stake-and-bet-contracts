...
contract ApiConsumerTest is Test {
  ...
  function test_initialContractState() public {
    ...
    assertTrue(apiConsumer.hasRole(apiConsumer.DEFAULT_ADMIN_ROLE(), admin));
  }
  ...
  function test_stringToBytes32() public {
    ...
    assertEq(
      derivedApiConsumer.stringToBytes32("RightJobIdWhoIs32CharacterLength"),
  ...
  function getDayStartingTimestamp(uint32 timestamp)
    internal
    pure
    returns (uint32)
  {
